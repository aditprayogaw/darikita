...
<!-- Awal Navigasi -->
    <nav class="bg-warna_bg shadow-lg fixed top-0 left-0 right-0 z-40">
...
<!-- Akhir Navigasi -->
    ...
    <div id="default-carousel" class="relative w-full max-w-screen-xl mx-auto mt-32 px-24 pb-4" data-carousel="slide">
        <!-- Carousel wrapper -->
        <div class="relative h-56 overflow-hidden bg-blue-200 rounded-lg md:h-96 mx-auto p-4">
            <!-- Item 1 -->
            <div class="hidden duration-700 ease-in-out" data-carousel-item>
                <img src="assets/img/image1.jpeg" class="absolute block bg-black w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
            </div>
            <!-- Item 2 -->
            <div class="hidden duration-700 ease-in-out" data-carousel-item>
                <img src="assets/img/image2.jpeg" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
            </div>
            <!-- Item 3 -->
            <div class="hidden duration-700 ease-in-out" data-carousel-item>
                <img src="assets/img/image3.jpeg" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
            </div>
        </div>
        <!-- Slider indicators -->
        ...
        <!-- Slider controls -->
        <button type="button" class="absolute top-0 start-0 z-30 flex items-center justify-center h-full px-28 cursor-pointer group focus:outline-none" data-carousel-prev>
        ...
        <button type="button" class="absolute top-0 end-0 z-30 flex items-center justify-center h-full px-28 cursor-pointer group focus:outline-none" data-carousel-next>
            <span class="inline-flex items-center justify-center w-10 h-10 rounded-full bg-white/30 dark:bg-gray-800/30 group-hover:bg-white/50 dark:group-hover:bg-gray-800/60 group-focus:ring-4 group-focus:ring-white dark:group-focus:ring-gray-800/70 group-focus:outline-none">
                <svg class="w-4 h-4 text-white dark:text-gray-800 rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
    ...
    <section>
        <div class="max-w-2xl mx-auto p-6">
            ...
            <div class="bg-white rounded-lg shadow-md p-4 mb-8" id="yayasan-update">
                <div class="flex justify-center items-center border-2 border-gray-300 rounded-lg">
                    <img class="h-full w-full max-w-lg rounded-lg" src="assets/img/image9.jpeg" alt="yayasan...">
