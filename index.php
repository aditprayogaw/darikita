    ...
    <section class="bg-[#F1F1F1] max-w-screen-xl flex flex-wrap rounded-md justify-between mx-auto p-4 mt-32 mb-14">
        <div id="default-carousel" class="relative w-full" data-carousel="slide">
            ...
            <button type="button" class="absolute top-0 start-0 z-10 flex items-center justify-center h-full px-4 cursor-pointer group focus:outline-none" data-carousel-prev>
                <span class="inline-flex items-center justify-center w-10 h-10 rounded-full bg-black/30 dark:bg-gray-800/30 group-hover:bg-warna_aksen/50 dark:group-hover:bg-gray-800/60 group-focus:ring-4 group-focus:ring-white dark:group-focus:ring-gray-800/70 group-focus:outline-none">
