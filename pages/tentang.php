...
<!-- Akhir Navigasi -->
    ...
    <main class="max-w-screen-xl justify-between mx-auto p-4 mt-20 mb-14">
        ...
        <!-- yang ini FAQs Section dah bener gasi gini ? hehe -->
        <div class="mt-12 mb-10">
            <h2 class="sm:text-2xl text-2xl font-bold text-center text-gray-900 mb-3">FAQs</h2>
            <div class="w-[100px] mt-4 h-[2px] mx-auto bg-gray-500 mb-4"></div>
            <div class="mt-6 space-y-4">
                <div class="bg-white shadow-md rounded-lg p-4">
                    <button class="flex justify-between w-full text-left text-gray-900 font-medium text-lg">
                        Siapa yang bisa berdonasi di darikita.com?
                ...
                <div class="bg-white shadow-md rounded-lg p-4">
                    <button class="flex justify-between w-full text-left text-gray-900 font-medium text-lg">
                        Bagaimana cara darikita.com mendistribusikan makanan?
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                        </svg>
                    </button>
                ...
                <div class="bg-white shadow-md rounded-lg p-4">
                    <button class="flex justify-between w-full text-left text-gray-900 font-medium text-lg">
                        Bagaimana cara memastikan bahwa donasi saya digunakan dengan tepat?
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                        </svg>
                    </button>
                ...
                <div class="bg-white shadow-md rounded-lg p-4">
                    <button class="flex justify-between w-full text-left text-gray-900 font-medium text-lg">
                        Apa yang bisa saya lakukan untuk membantu darikita.com selain berdonasi?
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                        </svg>
                    </button>
